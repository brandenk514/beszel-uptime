...
export function WindowsIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg {...props} viewBox="0 0 48 48" aria-hidden="true">
			<path
				fill="none"
				stroke="currentColor"
				strokeWidth="3.8"
...
export function DockerIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg {...props} viewBox="0 0 512 512" fill="currentColor" aria-hidden="true">
...
export function ChartAverage(props: SVGProps<SVGSVGElement>) {
	return (
		<svg fill="none" viewBox="0 0 48 48" stroke="currentColor" {...props} aria-hidden="true">
...
export function ThermometerIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg viewBox="0 0 256 256" {...props} fill="currentColor" aria-hidden="true">
...
export function GpuIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg viewBox="0 0 24 24" {...props} stroke="currentColor" fill="none" strokeWidth="2" aria-hidden="true">
...
export function WebSocketIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg viewBox="0 0 256 193" {...props} fill="currentColor" aria-hidden="true">
